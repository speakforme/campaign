...
def upgrade():
    ...
    op.create_table('mail_account',
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=False),
        sa.Column('friendly_id', sa.Unicode(length=255), nullable=False),
    ...
    op.create_unique_constraint('mail_account_organization_id_friendly_id_key', 'mail_account', ['organization_id', 'friendly_id'])
...
def downgrade():
    ...
    op.drop_constraint('mail_account_organization_id_friendly_id_key', 'mail_account', type_='unique')
